...
namespace ProsjektStyring.Migrations
{
    ...
    [Migration("20190427133824_added teams, and supporttables")]
    partial class addedteamsandsupporttables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProsjektStyring.Data.Team", b =>
                {
                    ...
                    b.Property<string>("Team_UniqueId");
            ...
            modelBuilder.Entity("ProsjektStyring.Data.TeamMember", b =>
                {
                    b.Property<int>("TeamId");
            ...
            modelBuilder.Entity("ProsjektStyring.Data.TeamToProject", b =>
                {
                    b.Property<int>("TeamId");
            ...
            modelBuilder.Entity("ProsjektStyring.Data.TeamMember", b =>
                {
                    b.HasOne("ProsjektStyring.Data.Team", "Team")
                        .WithMany()
                        .HasForeignKey("TeamId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ProsjektStyring.Data.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
